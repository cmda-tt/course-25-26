...
Deze les ligt de focus op D3 scales, assen, joins, domain en range. Om een dataset goed geschaald in een visualizatie op je scherm te krijgen is het belangrijk dat je weet hoe je een dataset kan 'mappen' met domain en range. Dit concept gebruik je vervolgens om assen met labels en ticks te maken.
...
Handig om te weten is dat er een nieuwe Major van Svelte is gereleased (van 4 naar 5). Daar zit een nieuw binding concept in wat Runes heet. Dat werkt goed samen met bijvoorbeeld D3 data joins. Svelte is daarom 1 van de frameworks is die wordt aangeraden in de D3 docs en het ook in het werkveld vaak een default stack is voor data visualisatie mensen. Kijk eens of je runes en data joins van D3 kunt combineren in het filteren en updaten van je visualisatie.
